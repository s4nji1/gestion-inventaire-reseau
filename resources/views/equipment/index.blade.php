            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="md:col-span-1">
                    <form action="{{ route('equipment.search') }}" method="GET" class="flex">
                        <input type="text" name="query" value="{{ $query ?? '' }}" placeholder="Search equipment..." class="flex-1 shadow-sm border-gray-300 rounded-l-md focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                ...
                <div class="md:col-span-2">
                    <form action="{{ route('equipment.filter') }}" method="GET" class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            <label for="category_id" class="block text-sm font-medium text-gray-700">Category</label>
                            <select id="category_id" name="category_id" class="mt-1 block w-full shadow-sm border-gray-300 rounded-md focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                        ...
                        <div>
                            ...
                            <select id="status_id" name="status_id" class="mt-1 block w-full shadow-sm border-gray-300 rounded-md focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex justify-end space-x-2">
                                    ...
                                    <form action="{{ route('equipment.destroy', $item) }}" method="POST" class="inline-block">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="text-red-600 hover:text-red-900" title="Delete" onclick="return confirm('Are you sure you want to delete this equipment?')">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <tr>
                            <td colspan="6" class="px-6 py-10 text-center text-gray-500">
                                <div class="flex flex-col items-center">
                                    ...
                                    @if(isset($categoryId) || isset($statusId) || isset($query))
                                        <a href="{{ route('equipment.index') }}" class="mt-2 text-blue-600 hover:text-blue-800">Clear filters and try again</a>
                                    @else
                                        <a href="{{ route('equipment.create') }}" class="mt-2 text-blue-600 hover:text-blue-800">Add your first equipment</a>
                                    @endif
                                </div>
                            </td>
                        </tr>
