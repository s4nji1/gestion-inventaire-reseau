...
<div class="w-full">
    ...
    <div class="bg-white rounded-lg shadow">
        ...
        <div class="flex space-x-2">
            <!-- Simple CSV Export -->
            <a href="{{ route('maintenance.export.csv') }}" class="inline-flex items-center px-4 py-2 bg-green-600 border border-transparent rounded-md font-semibold text-xs text-blue uppercase tracking-widest hover:bg-green-500">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <!-- Simple PDF Export -->
            <a href="{{ route('maintenance.export.pdf') }}?category_id={{ request('category_id') }}&status_id={{ request('status_id') }}"
