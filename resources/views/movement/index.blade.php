            ...
            <div class="p-4">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div class="md:col-span-1">
                        <form action="{{ route('movement.search') }}" method="GET" class="flex">
                            <input type="text" name="query" value="{{ $query ?? '' }}"
                                placeholder="Search equipment, notes..."
                    ...
                    <div class="md:col-span-2">
                        <form action="{{ route('movement.filter') }}" method="GET"
                            class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                <select name="type"
                                    class="block w-full shadow-sm border-gray-300 rounded-md focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                                    <option value="">All Movement Types</option>
                                    <option value="entry" {{ isset($type) && $type == 'entry' ? 'selected' : '' }}>Entry
                                    </option>
                                    <option value="exit" {{ isset($type) && $type == 'exit' ? 'selected' : '' }}>Exit
                                    </option>
                                    <option value="maintenance"
                                        {{ isset($type) && $type == 'maintenance' ? 'selected' : '' }}>Maintenance
                                    </option>
                                </select>
                            </div>
                            <br>
        ...
        <div class="bg-white rounded-lg shadow">
            ...
            <div class="overflow-x-auto">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex justify-end space-x-2">
                                        ...
                                        <a href="{{ route('movement.edit', $movement) }}"
                                        ...
                                        <a href="{{ route('equipment.show', $movement->equipment_id) }}"
                                            class="text-green-600 hover:text-green-900" title="View Equipment">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none"
                                                viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        ...
                                        <form action="{{ route('movement.destroy', $movement) }}" method="POST"
                                            class="inline-block">
                                            @csrf
                                            @method('DELETE')
                                ...
                                <tr>
                                    <td colspan="6" class="px-6 py-10 text-center text-gray-500">
                                        <div class="flex flex-col items-center">
                                            ...
                                            @else
                                                <a href="{{ route('movement.create') }}"
                                                    class="mt-2 text-blue-600 hover:text-blue-800">Add your first movement
                                                    record</a>
                                            @endif
                                        </div>
                                    </td>
                ...
                <div class="flex space-x-2">
                    <!-- Simple CSV Export -->
                    <a href="{{ route('movement.export.csv') }}"
                    ...
                    <!-- Simple PDF Export -->
                    <a href="{{ route('movement.export.pdf') }}?category_id={{ request('category_id') }}&status_id={{ request('status_id') }}"
